...
The tag `v1.0.0` is already created. Now create the release:

## Quick Steps

1. **Open this link**: https://github.com/shoutgeorge1/dj-gui/releases/new

2. **The form will auto-fill with tag `v1.0.0`**

3. **Fill in**:
   - **Title**: `DrumSep GUI v1.0.0`
   - **Description**: Copy from `CREATE_RELEASE_NOW.md` or use the template below
   - **Check**: ✅ "Set as a draft" (since .exe isn't ready yet)

4. **Click**: "Publish release"

5. **Done!** The release will be at: https://github.com/shoutgeorge1/dj-gui/releases/tag/v1.0.0
...
1. Go to: https://github.com/shoutgeorge1/dj-gui/releases/tag/v1.0.0
